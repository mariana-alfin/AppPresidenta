...
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.creacionComplementosApp
...
class NIPActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title =
            HtmlCompat.fromHtml("<font color='#2C3B62'>" + getString(R.string.crea_nip) + "</font>",
        ...
        val request = object : JsonObjectRequest(
            ...
            Response.ErrorListener { error ->
                try {
                    ...
                    if (codigo == 422) {
                        mensaje =
                            "El NIP ingresado no puede ser igual al NIP registrado, ingresa uno diferente."
                    }
