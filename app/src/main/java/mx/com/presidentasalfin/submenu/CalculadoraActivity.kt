...
class CalculadoraActivity : AppCompatActivity(), OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = HtmlCompat.fromHtml("<font color='#FFFFFF'>Calculadora</font>",
        ...
        findViewById<TextView>(R.id.txtNota).text =
            HtmlCompat.fromHtml("<font color='#3C8943'>Nota:</font><font color='#000000'> Recuerda que si el prestamo no se liquida se perdera la bolsa acumulada.</font>",
                HtmlCompat.FROM_HTML_MODE_LEGACY)
    }
