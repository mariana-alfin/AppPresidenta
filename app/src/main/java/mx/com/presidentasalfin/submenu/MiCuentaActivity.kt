...
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.encriptacion
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.setMaxLength
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.toDp
...
class MiCuentaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title =
            HtmlCompat.fromHtml("<font color='#FFFFFF' face='montserrat_extra_bold_italic'>Mi Cuenta</font>",
    ...
    private fun ingresarNip(esObligatorio: Boolean) {
        ...
        if (!esObligatorio) {
            ...
            alert.setMessage(HtmlCompat.fromHtml("<font color='#D63031' face='montserrat_medium_italic'>Para continuar, es necesario que indiques tu NIP actual</font>",
                HtmlCompat.FROM_HTML_MODE_LEGACY))
