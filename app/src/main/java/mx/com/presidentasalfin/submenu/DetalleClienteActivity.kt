package mx.com.presidentasalfin.submenu
...
class DetalleClienteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title =
            HtmlCompat.fromHtml("<font color='#FFFFFF' face='montserrat_extra_bold_italic'>Detalle Cliente</font>",
    ...
    private fun detalleCliente(credit_id: Int) {
        ...
        val alertError =
            mostrarAlert(this, "error", true, "Detalle Cliente", getString(R.string.error), false)
    ...
    private fun pintarTablaDetalle(jsonResults: JSONObject) {
        ...
        findViewById<ImageView>(R.id.imaWhats).setOnClickListener {
            validacionesEnvioWhats(telefono,
                getString(R.string.mensaje_whats) + " " + nombre)
        }
