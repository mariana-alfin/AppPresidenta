...
import mx.com.presidentasalfin.databinding.MiGrupoFragmentBinding
import mx.com.presidentasalfin.generales.FuncionesGlobales
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.enviarMensajeWhatsApp
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.llamarContacto
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.mostrarAlert
import mx.com.presidentasalfin.generales.FuncionesGlobales.Companion.validarAplicacionInstalada
import mx.com.presidentasalfin.generales.ValGlobales
import mx.com.presidentasalfin.submenu.DetalleClienteActivity
...
class MiGrupoFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title =
            HtmlCompat.fromHtml("<font face='montserrat_extra_bold_italic'>$grupo</font>",
    ...
    private fun datosDelGrupo() {
        ...
        val alertError = mostrarAlert(requireActivity(),
            "error",
            true,
            "Mi Grupo",
    ...
    private fun llenarTablaClientes(jsonClientes: JSONArray) {
        ...
        for (i in 0 until numClientes) {
            ...
            txtP.typeface =
                ResourcesCompat.getFont(requireActivity(), R.font.montserrat_semi_bold_italic)
    ...
    private fun validacionesEnvioWhats(telefono: String, nombreclienta: String) {
        ...
        if (!validarAplicacionInstalada(getString(R.string.packagename_whats), context)) {
            ...
            val alert = mostrarAlert(requireActivity(),
                "advertencia",
                false,
                "Advertencia",
                getString(R.string.instalacion_app),
                true)
