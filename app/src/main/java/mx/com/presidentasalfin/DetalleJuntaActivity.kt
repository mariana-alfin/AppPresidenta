...
class DetalleJuntaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ValGlobales.validarConexion(this)) {
            ...
            findViewById<TextView>(R.id.txtCargando).text =
                getString(R.string.noConexion)
        ...
        try {
            ...
            val request = object : JsonObjectRequest(
                ...
                override fun getHeaders(): Map<String, String> {
                    ...
                    headers["X-Header-Email"] =
                        getString(R.string.header_email)
                    headers["X-Header-Password"] =
                        getString(R.string.header_password)
                    headers["X-Header-Api-Key"] =
                        getString(R.string.header_api_key)
                    return headers
                }
            }
    ...
    private fun pintarTablaJunta(jsonClientes: JSONArray) {
        ...
        for (i in 0 until numClientes) {
            ...
            var colorSolidario = when (solidario) {
                "DA" -> {
                    ContextCompat.getColor(this, R.color.Verde3)
                }
                "RE" -> {
                    Color.RED
                }
