    ...
    override fun onCreateView(
        ...
        if (ValGlobales.validarConexion(activity as AppCompatActivity)) {
            try {
                ...
                val json =
                    "[ { \"credit_id\": 177681, \"pay_id\": 830996, \"pay_number\": 1, \"bonus_amount\": \"9000.00\", \"stock_amount\": \"3600.00\", \"bonus_status_id\": 0, \"payment_date\": \"20/12/2021\" }, { \"credit_id\": 177681, \"pay_id\": 833568, \"pay_number\": 2, \"bonus_amount\": \"9000.00\", \"stock_amount\": \"2700.00\", \"bonus_status_id\": 1, \"payment_date\": null }, {\"credit_id\": 177681, \"pay_id\": 841680, \"pay_number\": 3, \"bonus_amount\": \"9000.00\", \"stock_amount\": \"3600.00\", \"bonus_status_id\": 1, \"payment_date\": null }, { \"credit_id\": 177681, \"pay_id\": 856563, \"pay_number\": 4, \"bonus_amount\": \"9000.00\", \"stock_amount\": \"2700.00\", \"bonus_status_id\": 1, \"payment_date\": null }, { \"credit_id\": 177681, \"pay_id\": 866339, \"pay_number\": 5, \"bonus_amount\": \"9000.00\", \"stock_amount\": \"3600.00\", \"bonus_status_id\": 1, \"payment_date\": null }] "
                val jsonDataP = JSONArray(json)
                //val jsonResultsP = jsonDataP.getString("results")
                //mostrarDatosBonificacion(numPagoActual, jsonDataP)
...
//SE HACE EL CALCULO DE LAS SEMANAS
                ...
                val fecha = TextView(context)
                fecha.text = "\t\t" + bono.getInt("pay_number")
                fecha.gravity = Gravity.CENTER
