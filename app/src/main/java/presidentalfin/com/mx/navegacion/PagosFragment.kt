...
import presidentalfin.com.mx.JuntaActivity
import presidentalfin.com.mx.JuntaConciliacionActivity
import presidentalfin.com.mx.R
import presidentalfin.com.mx.databinding.PagosFragmentBinding
        ...
        if (juntas.length() != 0){
            ...
            builder.setPositiveButton("Aceptar") { dialog, which ->
                ...
                if(task_number != 0 && idPago != 0){
                    ...
                    val detalleJunta = Intent(activity, presidentalfin.com.mx.DetalleJuntaActivity::class.java)
                    //MD ENVIAMOS DATOS
