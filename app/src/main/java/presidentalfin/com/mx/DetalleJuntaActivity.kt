...
import presidentalfin.com.mx.generales.FuncionesGlobales.Companion.convertPesos
...
class DetalleJuntaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setLogo(presidentalfin.com.mx.R.mipmap.icono_app)
        supportActionBar?.setDisplayShowHomeEnabled(true)
        supportActionBar?.setDisplayUseLogoEnabled(true)
        supportActionBar?.setBackgroundDrawable(getDrawable(presidentalfin.com.mx.R.drawable.barra_v6))
        ...
        if (ValGlobales.validarConexion(this)) {
            ...
            findViewById<TextView>(R.id.txtCargando).text = getString(presidentalfin.com.mx.R.string.noConexion)
    ...
    private fun mostrarFormato(esMostrar: Boolean) {
        ...
        progressBar = findViewById(presidentalfin.com.mx.R.id.cargando)
        ...
        findViewById<TextView>(presidentalfin.com.mx.R.id.txtCargando).visibility = valorLoadi
        findViewById<TextView>(presidentalfin.com.mx.R.id.txtDatosPago).visibility = valor
    }
    ...
    private fun datosJunta(payId: Int, taskNumber: Int) {
        ...
        val alertError = FuncionesGlobales.mostrarAlert(
            ...
            true,
            "Datos Junta",
            getString(presidentalfin.com.mx.R.string.error),
            false
        )
        try {
            ...
            val request = object : JsonObjectRequest(
                Method.POST,
                getString(presidentalfin.com.mx.R.string.urlDatosJuntasPgo),
                jsonParametros,
                ...
                Response.ErrorListener { error ->
                    ...
                    try {
                        if (codigoError == 422) {
                            ...
                            alertError.setMessage("Error: $codigoError \n${getString(presidentalfin.com.mx.R.string.errorServidor)}")
                        }
                    } catch (e: Exception) {
                ...
                override fun getHeaders(): Map<String, String> {
                    ...
                    headers["Content-Type"] = getString(presidentalfin.com.mx.R.string.content_type)
                    headers["X-Header-Email"] = getString(presidentalfin.com.mx.R.string.header_email)
                    headers["X-Header-Password"] = getString(presidentalfin.com.mx.R.string.header_password)
                    headers["X-Header-Api-Key"] = getString(presidentalfin.com.mx.R.string.header_api_key)
                    return headers
                }
            }
    ...
    private fun pintarTablaJunta(jsonClientes: JSONArray) {
        //SE OBTIENE LA TABLA
        val tabla = findViewById<TableLayout>(presidentalfin.com.mx.R.id.tblJunta)
        ...
        so.setTextColor(ContextCompat.getColor(this, presidentalfin.com.mx.R.color.Verde2))
        so.setTypeface(null, Typeface.BOLD_ITALIC)
        so.textSize = fontTh
        trEn.addView(so)

        trEn.gravity = Gravity.CENTER
        trEn.setBackgroundResource(presidentalfin.com.mx.R.drawable.redondo_verde)
        tabla.addView(
        ...
        for (i in 0 until numClientes) {
            ...
            if (i != numClientes) {
                tr.setBackgroundResource(presidentalfin.com.mx.R.drawable.borde)
            } else {
                tr.setBackgroundResource(presidentalfin.com.mx.R.drawable.borde_redondeado_verde)
            }
            ...
            val colorAzul = ContextCompat.getColor(this, presidentalfin.com.mx.R.color.Azul1)
            val cliente = TextView(this)
            ...
            var colorSolidario = when (solidario){
                "DA" -> {ContextCompat.getColor(this, presidentalfin.com.mx.R.color.Verde3)}
                "RE" -> {Color.RED}
                "NA" -> {Color.BLACK}
                else -> {Color.BLACK}
            }
